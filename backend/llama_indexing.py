...
class TransactionProcessor:
    ...
    def create_document(self, transaction):
        text = f"""
        Transaction {transaction['stripe_id']} made by {transaction['billing_name']} 
        on {transaction['timestamp']} for {transaction['amount']} {transaction['currency']}.
        ...
        doc = Document(
            ...
            metadata={
                ...
                'is_fake_city': transaction.get('is_fake_city', False),
                'is_fake_street': transaction.get('is_fake_street', False),
