...
const Hero = () => {
  return (
    <section className="mt-2  w-full h-200 my-0 mx-auto flex items-center justify-center text-center">
        <div className="w-[1256px] h-[440px] bg-[#112d2b] bg-opacity-60 rounded-xl shadow-lg flex flex-col justify-center items-center">
            <h1 className="text-5xl mb-6">Detect fraud in real-time.<br /> Protect transactions with AI.</h1>
