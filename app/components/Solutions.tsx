    ...
    return (
        <section id="solutions" className="w-full">
            <div className="my-0 mb-auto lg:px-16">
                <h2 className="mb-3 text-xl text-center md:mb-4 md:text-4xl lg:mb-10">
                    Solutions
                </h2>
                <div className="grid gap-6 md:grid-cols-2 lg:gap-8">
                    <div className="flex flex-col overflow-clip rounded-xl md:col-span-2 md:grid md:grid-cols-2 md:gap-6 lg:gap-8">
                        <div className="flex flex-col text-center justify-center px-6 py-8 md:px-8 md:py-10 lg:px-10 lg:py-12">
