...
export function SectionCards({transactions}: {transactions: any}) {
    ...
    const lowRiskTransactions = transactions.filter((transaction: any) => transaction.predicted_risk === "low")
    const highRiskTransactions = transactions.filter((transaction: any) => transaction.predicted_risk === "high") 
    const mediumRiskTransactions = transactions.filter((transaction: any) => transaction.predicted_risk === "medium")
